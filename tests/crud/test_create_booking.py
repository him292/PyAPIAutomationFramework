...
class TestCreateBooking(object):
    ...
    @allure.description(
        "Creating a Booking from the payload and verfiy that booking id should not be null and status code should be 200 for the correct payload")
    ...
    @allure.description(
        "Creating a Booking with no payload and verify that booking id is not generated")
